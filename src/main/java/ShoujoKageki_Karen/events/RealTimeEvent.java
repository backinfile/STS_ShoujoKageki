package ShoujoKageki_Karen.events;

import ShoujoKageki_Karen.KarenPath;
import ShoujoKageki_Karen.cards.shine.RealTimeAttack;
...
public class RealTimeEvent extends AbstractImageEvent {
    ...
    public static final String IMG = KarenPath.makeEventPath(RAW_ID + ".png");
