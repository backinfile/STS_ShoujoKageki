...
import ShoujoKageki_Karen.actions.MoveAllShineCardsIntoBagAction;
import ShoujoKageki_Karen.actions.StarAction;
...
public class StarGuide extends BaseCard {
    ...
    public static final String ID = KarenPath.makeID(StarGuide.class.getSimpleName());
