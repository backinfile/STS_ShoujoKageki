...
import ShoujoKageki_Karen.actions.GainCardOrIgnoreAction;
...
public class ShinePotion extends BasePotion {
    ...
    public static final String POTION_ID = KarenPath.makeID(ShinePotion.class.getSimpleName());
    ...
    public void use(AbstractCreature abstractCreature) {
        List<AbstractCard> collect = ShoujoKagekiKarenManager.allKarenCardList.stream()
