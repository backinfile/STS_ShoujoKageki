package ShoujoKageki.ui.showDisposeInHistory.patch;
...
public class RunPathElementPatch {
    public static final UIStrings UI_STRINGS = CardCrawlGame.languagePack.getUIString(ModInfo.makeID("RunPathElement"));
