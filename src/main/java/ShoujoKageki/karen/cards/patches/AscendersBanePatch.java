...
import ShoujoKageki.karen.cards.starter.Sleepy;
            ...
            return new ExprEditor() {
                ...
                public void edit(NewExpr e) throws CannotCompileException {
                    if (e.getClassName().equals(AscendersBane.class.getName())) {
                        e.replace("{if (com.megacrit.cardcrawl.dungeons.AbstractDungeon.player instanceof ShoujoKageki.character.KarenCharacter){$_= new " + Sleepy.class.getName() + "();} else {$_=$proceed($$);}}");
                    }
                }
            };
        }
