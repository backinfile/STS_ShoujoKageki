...
public class CryPowerTmp extends BasePower {
    public static final Logger logger = LogManager.getLogger(CryPowerTmp.class.getName());

    private static final String RAW_ID = CryPowerTmp.class.getSimpleName();
