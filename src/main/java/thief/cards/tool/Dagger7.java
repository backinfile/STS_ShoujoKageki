...
public class Dagger7 extends ToolCard {
    public static final String ID = makeID(Dagger7.class.getSimpleName());
    public static final String IMG = makeCardPath("Attack.png");

    public Dagger7() {
        super(ID, IMG, 0, CardType.ATTACK, CardRarity.UNCOMMON, CardTarget.ENEMY, 2);
        baseDamage = 6;
    }
