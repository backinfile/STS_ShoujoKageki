...
public class MetricDataPatch {
    ...
    public static class Damage {
        public static void Postfix(Metrics __instance, HashMap<Object, Object> ___params) {
            ___params.put("sjc_disposedCards", getDisposedCards(CardCrawlGame.metricData));
            ___params.put("sjc_disposedCardsCount", Field.disposedCardsCount.get(CardCrawlGame.metricData));
        }
    }
